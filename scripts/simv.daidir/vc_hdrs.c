...
#ifndef __VCS_IMPORT_DPI_STUB_vc_uvmOnewayHash
#define __VCS_IMPORT_DPI_STUB_vc_uvmOnewayHash
__attribute__((weak)) int vc_uvmOnewayHash(/* INPUT */const char* A_1, /* INPUT */int A_2)
{
    ...
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (int (*)(const char* A_1, int A_2)) dlsym(RTLD_NEXT, "vc_uvmOnewayHash");
    ...
    if (_vcs_dpi_fp_) {
        ...
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "vc_uvmOnewayHash");
        return 0;
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_vc_uvmOnewayHash */

#ifndef __VCS_IMPORT_DPI_STUB_vc_uvmCreateRandomSeed
#define __VCS_IMPORT_DPI_STUB_vc_uvmCreateRandomSeed
__attribute__((weak)) int vc_uvmCreateRandomSeed(/* INPUT */const char* A_1, /* INPUT */int A_2)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static int (*_vcs_dpi_fp_)(/* INPUT */const char* A_1, /* INPUT */int A_2) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (int (*)(const char* A_1, int A_2)) dlsym(RTLD_NEXT, "vc_uvmCreateRandomSeed");
        _vcs_dpi_stub_initialized_ = 1;
    }
    if (_vcs_dpi_fp_) {
        return _vcs_dpi_fp_(A_1, A_2);
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "vc_uvmCreateRandomSeed");
        return 0;
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_vc_uvmCreateRandomSeed */

#ifndef __VCS_IMPORT_DPI_STUB_vc_uvmReseed
#define __VCS_IMPORT_DPI_STUB_vc_uvmReseed
__attribute__((weak)) void vc_uvmReseed()
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)() = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (void (*)()) dlsym(RTLD_NEXT, "vc_uvmReseed");
        _vcs_dpi_stub_initialized_ = 1;
    }
    if (_vcs_dpi_fp_) {
        _vcs_dpi_fp_();
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "vc_uvmReseed");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_vc_uvmReseed */
